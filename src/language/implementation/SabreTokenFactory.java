...
import language.implementation.symbols.expressions.ExpressionRules;
...
import language.implementation.symbols.expressions.assignment.AssignRules;
...
import language.implementation.symbols.patterns.PatternRules;
...
public class SabreTokenFactory implements TokenFactory<Visitor>{	
	...
	public List<Production<Visitor>> newProductions() {
		...
		ExpressionRules.addAll(list);
		DeclarationRules.addAll(list);
		TypeRules.addAll(list);
		PatternRules.addAll(list);
