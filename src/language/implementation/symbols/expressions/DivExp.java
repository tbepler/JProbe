...
public class DivExp extends Expression{
	...
	private static final List<Class<? extends Symbol<Visitor>>> RHS =
			ListUtil.asUnmodifiableList(Expression.class, Div.class, Expression.class);
	
	public final Expression left, right;
	
	public DivExp(Expression left, Expression right){this.left = left; this.right = right; }
	...
	public Symbol<Visitor> reduce(List<Symbol<Visitor>> symbols) {
		...
		return new DivExp((Expression) symbols.get(0), (Expression) symbols.get(2));
	}
