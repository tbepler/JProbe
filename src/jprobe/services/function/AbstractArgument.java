...
public abstract class AbstractArgument<P> implements Argument<P> {
	...
	protected AbstractArgument(String name, String tooltip, String category, boolean optional){
		m_Name = name; m_Tooltip = tooltip; m_Category = category; m_Optional = optional;
	}
